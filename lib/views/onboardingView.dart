import 'package:arcore_example/views/welcomeView.dart';
                  ...
                  child: PageView(
                    ...
                    children: <Widget>[
                      dadosOnBoarding(
                          ...
                          titulo: 'Adquira hoje um dado pessoal importante',
                          subtitulo:
                          'Tenha o seu código-postal e um endereço padronizado'),
                      dadosOnBoarding(
                          imgUrl: "assets/icon1.json",
                          titulo: 'Criamos um sistema postal para si',
                          subtitulo:
                          'A partir dos pontos de referência que você dá para seus amigos encontrarem sua morada'),
                      dadosOnBoarding(
                          imgUrl: 'https://assets6.lottiefiles.com/packages/lf20_clujqcpl.json',
                          titulo: 'Evite longas explicações sobre sua morada',
                          subtitulo:
                          'Apenas informe aos serviços e amigos, o seu Código Inzo'),
                      dadosOnBoarding(
                          imgUrl: 'https://assets6.lottiefiles.com/packages/lf20_clujqcpl.json',
                      ...
                      dadosOnBoarding(
                          imgUrl: 'https://assets6.lottiefiles.com/packages/lf20_clujqcpl.json',
                          titulo: 'Não importa onde você mora',
                          subtitulo:
                          'Mapeamos todos os pontos de referência de Angola'),
                    ],
                  ),
                ),
                Row(
